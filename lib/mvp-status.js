...
import { listCaptureFiles, parseCaptureFiles, sortRankingCandidates, summarizeCaptureFreshness } from "../scripts/capture-utils.js";
  ...
  const checks = [
    ...
    },
    {
      ...
      evidence: latestCapture.exists
        ...
        : "captures/ 尚未发现 DataEye motionComic 日榜目标请求"
    },
    {
      name: "最近 DataEye 预检",
...
function getLatestDataEyeCaptureStatus() {
  ...
  const selected = sortRankingCandidates(
